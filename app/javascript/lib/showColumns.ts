...
export const SHOW_COLUMN_GROUPS = buildColumnGroups([
  { label: 'General', columns: ['id', 'episode_count', 'updated_at', 'original_title', 'originally_available', 'season_count', 'sort_title', 'viewed_episode_count', 'year'] },
...
export const EPISODE_COLUMN_GROUPS = buildColumnGroups([
  { label: 'General', columns: ['id', 'duration', 'episode_count', 'updated_at', 'originally_available', 'season_count', 'sort_title', 'year'] },
